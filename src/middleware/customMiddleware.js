...
export const customMiddleware = store => next => action => {
  ...
  if (action.type === FILTER_LIST_AUCTIONS) {
    switch (action.filterTypeAuction) {
      case 1:
        action.auctions = _.orderBy(action.auctions, ['aid', 'createdAt'], ['desc', 'desc']);
        break;
      case 2:
      ...
      case 3:
        ...
        break;
      case 4:
        action.auctions = _.orderBy(action.auctions, ['product.chanceNumber'], ['desc']);
        break;
      case 5:
        action.auctions = _.orderBy(action.auctions, ['product.chanceNumber'], ['asc']);
        break;
      default:
        break;
    }
