                                            ...
                                            <div className="col-xs-12 col-sm-5 col-md-4 col-lg-4">
                                                <div className="sidebar_left">
                                                    <div className="box_sidebar">
                                                        <h3 className="box_sidebar_title">アカウント</h3>
                                                        <div className="box_sidebar_body">
                                                            ...
                                                            <div className="menu_sidebar">
                                                                <div className="menu_sidebar_inner">
                                                                    <ul>
                                                                        <li>
                                                                            <Link to="#" className="show-child-menu" onMouseEnter={this.childMenu} onMouseLeave={this.childMenu}>
                                                                            ...
                                                                            <ul className="child-menu">
                                                                                <li>
                                                                                    <Link to={`/help/friend`} className={activeRoute('/help/friend', this.props.location.pathname)}>
                                                                                        {t('menu_friend')}  <i className="fa fa-angle-right"></i>
                                                                                    </Link>
                                                                                </li>
                                                                                <li>
                                                                                    <Link to={`/help/point`} className={activeRoute('/help/point', this.props.location.pathname)}>
                                                                                        {t('menu_received_point')} <i className="fa fa-angle-right"></i>
                                                                                    </Link>
                                                                                </li>
                                                                                <li>
                                                                                    <Link to={`/help/coin`} className={activeRoute('/help/coin', this.props.location.pathname)}>
                                                                        ...
                                                                        <li>
                                                                            <Link to={`/help`} className={activeRoute('/help', this.props.location.pathname)}>
                                                                        ...
                                                                        <li>
                                                                            <Link to={`/help/address`} className={activeRoute('/help/address', this.props.location.pathname)}>
                                                                        ...
                                                                        <li>
                                                                            <Link to={`/help/coin_exchange_history`} className={activeRoute('/help/coin_exchange_history', this.props.location.pathname)}>
                                                                        ...
                                                                        <li>
                                                                            <Link to="/help/winner_history" className={activeRoute('/help/winner_history', this.props.location.pathname)}>
                                                                        ...
                                                                        <li>
                                                                            <Link to="/help/chance_buy_history" className={activeRoute('/help/chance_buy_history', this.props.location.pathname)}>
                                                                        ...
                                                                        <li>
                                                                            <Link to={`/help/contact`} className={activeRoute('/help/contact', this.props.location.pathname)}>
                                                                        ...
                                                                        <li>
                                                                            <Link to={`/help/policy`} className={activeRoute('/help/policy', this.props.location.pathname)}>
                                                                        ...
                                                                        <li>
                                                                            <Link to={`/help/terms`} className={activeRoute('/help/terms', this.props.location.pathname)}>
