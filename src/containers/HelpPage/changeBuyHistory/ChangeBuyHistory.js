                            ...
                            <div>
                                ...
                                <div className="mgt-20">
                                    <div className="common-table">
                                                ...
                                                <tbody>
                                                {
                                                    chanceBuyHistories.map((item, key) => (
                                                        <tr key={key}>
                                                            ...
                                                            <td>{ truncateText(item && item.auction && item.auction.product && item.auction.product.name) }</td>
                                        ...
                                        <Pagination data={chanceBuyHistories} limit={limit} onChange={this.handlePageChange} page={page} pages={pages} total={total}/>
                                    </div>
                                </div>
                            </div>
                        </div>
